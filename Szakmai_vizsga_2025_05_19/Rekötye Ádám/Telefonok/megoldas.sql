...
CREATE TABLE samsung (
    ...
    samsung_nev varchar(225) NOT NULL,
    samsung_max_memoria varchar(225) NOT NULL,
...
CREATE TABLE iphone (
    ...
    iphone_nev varchar(225) NOT NULL,
    iphone_max_memoria varchar(225) NOT NULL,
...
CREATE TABLE xiaomi (
    ...
    xiaomi_nev varchar(225) NOT NULL,
    xiaomi_max_memoria varchar(225) NOT NULL,
...
ALTER TABLE vasarlasok ADD FOREIGN KEY (iphone_ID) REFERENCES iphone(iphoneID);

ALTER TABLE vasarlasok ADD FOREIGN KEY (samsung_ID) REFERENCES samsung(samsungID);

ALTER TABLE vasarlasok ADD FOREIGN KEY (xiaomi_ID) REFERENCES xiaomi(xiaomiID);
-- 8. feladat: samsung, iphone és xiaomi táblák feltöltése
INSERT INTO xiaomi (xiaomi_nev, xiaomi_max_memoria, xiaomi_mennyisegi_ar) VALUES (?, ?, ?);
